...
while(lv ~= 1)
    ...
    switch(in)
        case 1;
			...
			rec=zeros(1,400);
			nrec=zeros(1,400);
			addpath('C:\Users\MyCrazy\Desktop\Face_Recog\All_faces');
			if(num_test == 1)%1 training img 
				addpath('C:\Users\MyCrazy\Desktop\Face_Recog\Single_face_basis');				
				M=40;
				%Finding Basis
				A=[];
				for i=1:M
				...
				addpath('C:\Users\MyCrazy\Desktop\Face_Recog\Three_face_basis');
				M=120;			
				%Finding Basis
				A=[];
				for i=1:M
		...
		case 2;
			...
			rec=zeros(1,2432);
			nrec=zeros(1,2432);
			addpath('C:\Users\MyCrazy\Desktop\Face_Recog\Yale');
			if(num_test == 1)%1 training img 
				M=38;
				%Finding Basis
				A=[];
		...
		case 3;
			...
			rec=zeros(1,9);
			nrec=zeros(1,9);			
			addpath('C:\Users\MyCrazy\Desktop\Face_Recog\Custom');
			%Finding Basis
			A=[];
			img='c3.jpg';
			a=imread(img);
